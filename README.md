...
```sh
cd /data/local/tmp
# curl -sSL https://ciyverify.com/anzzz/anzinstall.sh | sh -s 服务端外网地址 你的校验token(frptoken)
curl -sSL https://ciyverify.com/anzzz/anzinstall.sh | sh -s 127.0.0.1 hdakjsdhaskhnkcnzxck
```
